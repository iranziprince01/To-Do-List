...
listsContainer.addEventListener("click", (e) => {
  if (e.target.tagName.toLowerCase() === "li") {
    ...
    editInput.type = "text";
    editInput.value = selectedList.name;

    // Replace span with the input field
    e.target.parentElement.replaceChild(editInput, e.target);

    // Add an event listener to save changes on input blur
    editInput.addEventListener("blur", () => {
      selectedList.name = editInput.value;
      saveAndRender();
    });
...
tasksContainer.addEventListener("click", (e) => {
  if (e.target.tagName.toLowerCase() === "input") {
    ...
    const editInput = document.createElement("input");
    editInput.type = "text";
    editInput.value = selectedTask.name;

    // Replace label with the input field
    taskElement.replaceChild(editInput, e.target);
